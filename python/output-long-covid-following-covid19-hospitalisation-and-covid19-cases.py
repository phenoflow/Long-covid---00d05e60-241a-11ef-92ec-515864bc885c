...
def checkRow(row):
    ...
    row['long-covid-following-covid19-hospitalisation-and-covid19-identified'] = 'CASE';
    return row;
...
with open(sys.argv[1], 'r') as file_in, open('long-covid-cases.csv', 'w', newline='') as file_out:
    ...
    csv_writer = csv.DictWriter(file_out, list(set(csv_reader.fieldnames)-set(all_cases)-set(all_exclude)) + ['long-covid-following-covid19-hospitalisation-and-covid19-identified'])
    ...
    for row in csv_reader:
        ...
        new_row['long-covid-following-covid19-hospitalisation-and-covid19-identified'] = 'UNK';
